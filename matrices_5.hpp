...
typedef double 			matrix_item_t;	/** Tipo de dato que almacenará cada elemento de la matriz. */
typedef unsigned short int 	matrix_inx_t;	/** Tipo de dato para índices de la matriz.                 */
typedef unsigned short int 	vector_inx_t;	/** Tipo de dato para índices del vector  .                 */


//========================================================================================
// Cabecera de funciones generales
//========================================================================================
...
/**
	...
	\details 	Determinan si a es cero.
...
private:
	...
	bool traspuesta_;      /**< La matriz es traspuesta? */
...
/**
	...
	\details 	Devuelve la posición k dentro del vector M_ del elemento (i,j) de la matriz. Se supone que la matriz está indexada i -> 1 hasta m_ j-> 1 hasta n_.
...
/**
	...
	\details 	Devuelve el elemento de la posición (i,j) de la matriz. Se supone que la matriz está indexada i -> 1 hasta m_ j-> 1 hasta n_.
...
/**
	...
	\details 	Asigna un valor al elemento (i,j) de la matriz. Se supone que la matriz está indexada i -> 1 hasta m_ j-> 1 hasta n_.
